...
public class KanbanColumnEndpoints : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/kanban-columns", async (
            ...
            .WithDescription(
                "Cria uma coluna em um board existente. Valida ordem nao negativa, WIP limit nao negativo e ordem unica dentro do board.")
        ...
        app.MapGet("/api/boards/{boardId:guid}/kanban-columns", async (
            ...
            .WithTags("Colunas Kanban")
            .Produces<IEnumerable<KanbanColumnResponseDto>>()
            .Produces(400)
            .Produces(401)
            .WithOpenApi();
        ...
        app.MapPut("/api/kanban-columns/{id:guid}", async (
            ...
            .WithTags("Colunas Kanban")
            .Produces<KanbanColumnResponseDto>()
            .Produces(400)
            .Produces(401)
            .WithOpenApi();

...
public class BoardMemberEndpoints : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/board-members", async (
            ...
            .WithDescription(
                "Adiciona um usuario existente como membro de um board existente. Nao permite duplicidade nem criacao manual de Owner.")
        ...
        app.MapGet("/api/boards/{boardId:guid}/members", async (
            ...
            .WithTags("Membros de Board")
            .Produces<IEnumerable<BoardMemberResponseDto>>()
            .Produces(400)
            .Produces(401)
            .WithOpenApi();
        ...
        app.MapPut("/api/board-members/{id:guid}", async (
            ...
            .WithDescription(
                "Atualiza o papel de um membro do board. A role Owner nao pode ser atribuida ou removida por este endpoint.")
            .WithTags("Membros de Board")
            .Produces<BoardMemberResponseDto>()
            .Produces(400)
            .Produces(401)
            .WithOpenApi();
        ...
        app.MapDelete("/api/board-members/{id:guid}", async (
            ...
            .WithDescription(
                "Remove um membro do board. O membro com role Owner nao pode ser removido por este endpoint.")
            .WithTags("Membros de Board")
            .Produces(204)
            .Produces(400)
            .Produces(401)
